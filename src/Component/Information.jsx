    ...
    <div className="Information">
      ...
      <div className="EyeDisorder">
        ...
        <p>
          ...
          <a href="https://www.nei.nih.gov/learn-about-eye-health/eye-conditions-and-diseases/cataracts">Learn more about cataracts.</a>
        </p>
      </div>
      <div className="EyeDisorder">
        <h2>Glaucoma</h2>
        ...
        <p>
          ...
          <a href="https://www.nei.nih.gov/learn-about-eye-health/eye-conditions-and-diseases/glaucoma">Learn more about glaucoma.</a>
        </p>
      </div>
      <div className="EyeDisorder">
        ...
        <p>
          ...
          <a href="https://www.nei.nih.gov/learn-about-eye-health/eye-conditions-and-diseases/age-related-macular-degeneration">Learn more about macular degeneration.</a>
        </p>
      </div>
      <div className="EyeDisorder">
        ...
        <p>
          ...
          <a href="https://www.nei.nih.gov/learn-about-eye-health/eye-conditions-and-diseases/diabetic-retinopathy">Learn more about diabetic retinopathy.</a>
        </p>
      </div>
      <div className="EyeDisorder">
        ...
        <p>
          ...
          <a href="https://www.nei.nih.gov/learn-about-eye-health/eye-conditions-and-diseases/conjunctivitis-pink-eye">Learn more about conjunctivitis.</a>
        </p>
      </div>
    </div>
  );
