...
import AboutCSS from '../Component/AboutCSS.css'
...
const About = () => {
  return (
    <div className='about-container'>
      ...
      <div>
        <img src="https://images.pexels.com/photos/7163354/pexels-photo-7163354.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" className='employees-img' />
      ...
      <div className="care-about">
        ...
        <div className="img-container">
          <img src={tree} alt="tree-growth.png" className='box-img' />
        </div>
      </div>
      ...
      <div className="help-society">
        ...
        <div className="img-container">
          <img src={society} alt="" className='box-img' />
        </div>
      </div>
